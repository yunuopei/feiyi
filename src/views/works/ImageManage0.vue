    ...
    <div style="margin-top: 30px; ">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <div style="margin-top: 20px">
            ...
            <el-button style="float: right" round @click="addImage"><i style="margin-right: 5px" class="el-icon-circle-plus-outline"></i>添加图片</el-button>
          </div>
        </el-breadcrumb>
        <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-popover trigger="hover" placement="left">
                  <div align="center">
                    <img v-bind:src="'data:image/png;base64,' + scope.row.url" style='width: 250px; height: 250px; padding: 0px 0px; align-content: center' />
                  </div>
                  <p>{{scope.row.title}}</p>
                  <p>作者:
...
export default {
    ...
    methods:{
        ...
        getAllData() {
          ...
          this.$http.get("http://localhost:8083/images/findAll0").then(res=>{
        ...
        saveSelector(index, row){
          ...
          this.$http.post(
              "http://localhost:8083/images/updateImage",
              row
          ).then(res=>{
        ...
        handleDelete(index, id) {
          ...
          then(() => {
            this.$http.post(
                "http://localhost:8083/images/delete",
                {id: id}
            ).then(res=>{
              console.log(res);
              this.$message({
